...
import type SlLivcard from './livcard';
...
describe('<sl-livcard>', () => {
  ...
  describe('when provided no parameters', () => {
    before(async () => {
      el = await fixture<SlLivcard>(
        html` <sl-livcard>This is just a basic card. No image, no header, and no footer. Just your content.</sl-livcard> `
      );
    });
